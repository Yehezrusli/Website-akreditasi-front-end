...
class Tabel8f4 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      tabel8f4: [],
  ...
  render() {
    ...
    return (
      <> <div>
        <h3 className="text-black font-weight-light my-5 text-center">Tabel 8.f.4 Luaran penelitian/PkM yang dihasilkan mahasiswa</h3>
      </div>
